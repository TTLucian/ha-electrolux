...
CATALOG_WD: dict[str, ElectroluxDevice] = {
    ...
    "timeToNotify": ElectroluxDevice(
        ...
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.CONFIG,
        entity_icon="mdi:bell-clock",
        friendly_name="Time to Notify",
        entity_registry_enabled_default=False,
    ),
    "userSelections/programsOrder": ElectroluxDevice(
        capability_info={
            "access": "read",
            "type": "string",
            "values": {
        ...
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:list-box-outline",
        friendly_name="Program Order",
        entity_registry_enabled_default=False,
    ),
}
