...
CATALOG_AC: dict[str, ElectroluxDevice] = {
    ...
    # Sound volume: 0 = silent, 1 = on — binary on/off, modeled as a switch.
    # Type-agnostic: some models report boolean, others number (min 0, max 1).
    # The SWITCH device_class forces the entity type regardless.
    ...
    # Filter thresholds (manufacturer-set constants, diagnostic, disabled by default)
    "filterCleanThreshold": ElectroluxDevice(
        capability_info={"access": "constant", "type": "number"},
        device_class=SensorDeviceClass.DURATION,
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:air-filter",
        entity_registry_enabled_default=False,
        friendly_name="Filter Clean Threshold",
    ),
    "hEPAFilterBuyThreshold": ElectroluxDevice(
        capability_info={"access": "constant", "type": "number"},
        device_class=SensorDeviceClass.DURATION,
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:air-filter",
        entity_registry_enabled_default=False,
        friendly_name="HEPA Filter Buy Threshold",
    ),
    "hEPAFilterChangeThreshold": ElectroluxDevice(
        capability_info={"access": "constant", "type": "number"},
        device_class=SensorDeviceClass.DURATION,
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:air-filter",
        entity_registry_enabled_default=False,
        friendly_name="HEPA Filter Change Threshold",
    ),
