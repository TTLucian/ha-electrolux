"""Defined catalog of entities for structured oven type devices (SO).

SO (Structured Oven) appliances have their oven control capabilities nested under the
"upperOven" container, unlike regular ovens where capabilities are at the root level.
This catalog provides the correct entity_source paths for structured oven capabilities.
"""
...
# Structured oven specific catalog with upperOven/ prefixed entities
CATALOG_SO: dict[str, ElectroluxDevice] = {
    ...
    # Root-level structured oven configuration entities
    ...
    # Time offsets
    "applianceLocalTimeOffset": ElectroluxDevice(
        capability_info={"access": "readwrite", "type": "number"},
        device_class=None,
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.CONFIG,
        entity_icon="mdi:clock-edit",
        friendly_name="Appliance Local Time Offset",
        entity_registry_enabled_default=False,
    ),
    "autoLocalTimeOffset": ElectroluxDevice(
        capability_info={"access": "read", "type": "number"},
        device_class=None,
        unit=UnitOfTime.SECONDS,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:clock-auto",
        friendly_name="Auto Local Time Offset",
        entity_registry_enabled_default=False,
    ),
    # Favorite programs
    "favoriteOrder": ElectroluxDevice(
        capability_info={"access": "readwrite", "type": "array"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:star-circle",
        friendly_name="Favorite Order",
        entity_registry_enabled_default=False,
    ),
    "favoriteOrder/number": ElectroluxDevice(
        capability_info={"access": "read", "type": "int"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:star-circle",
        friendly_name="Favorite Order Count",
        entity_registry_enabled_default=False,
    ),
    "favoriteSelect": ElectroluxDevice(
        capability_info={"access": "readwrite", "type": "string"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.CONFIG,
        entity_icon="mdi:star",
        friendly_name="Favorite Select",
        entity_registry_enabled_default=False,
    ),
    "favoriteStatus": ElectroluxDevice(
        capability_info={"access": "read", "type": "array"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:star-check",
        friendly_name="Favorite Status",
        entity_registry_enabled_default=False,
    ),
    "favoriteStatus/number": ElectroluxDevice(
        capability_info={"access": "read", "type": "int"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_icon="mdi:star-check",
        friendly_name="Favorite Status Count",
        entity_registry_enabled_default=False,
    ),
    # Message queue sync
    "messageQueueSync/activeMessageIndex": ElectroluxDevice(
        capability_info={"access": "read", "type": "number"},
        device_class=None,
        unit=None,
        entity_category=EntityCategory.DIAGNOSTIC,
